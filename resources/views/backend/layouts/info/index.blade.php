@extends('backend.app', ['title' => 'Info'])
                    ...
                    <div class="card product-sales-main">
                        <div class="card-header border-bottom">
                            ...
                            <div class="card-options ms-auto">
                                <a href="{{ route('info.create') }}" class="btn btn-primary btn-sm">Add Task</a>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="">
